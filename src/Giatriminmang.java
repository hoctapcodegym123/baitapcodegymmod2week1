...
class Giatriminmang {
    public static void main(String[] args) {
        ...
        double[] numberArr = { 12.3, -4, 10, 4.24, 2, 71, -2, -5 };
        ...
        //dùng vòng lặp for duyệt các phần tử trong mảng. so sánh max với từng phần tử nếu số nào nhỏ hơn min thì gán nó cho min.
        // cứ lặp như vậy cho đến hết các phần tử thì min sẽ là giá trị nhỏ nhất trong mảng
